import { IconArchive, IconCalendarPlus, IconListCheck, IconNotes, IconUsersGroup } from '@tabler/icons-react';

export const MEETING_TAB_ITEMS = [
  { label: 'Summary', value: 'summary', icon: IconUsersGroup, badge: false },
  { label: 'Transcript', value: 'transcript', icon: IconArchive, badge: false },
